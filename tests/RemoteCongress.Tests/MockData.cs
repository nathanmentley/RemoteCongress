...
kwMRyHisc6diIMoNAgMBAAE=";
        ...
        /// <returns></returns>
        public static async Task<string> GetJson(ISignedData block) =>
            await _signedDataCodec.EncodeToString(
                _signedDataCodec.GetPreferredMediaType(),
                new SignedData(block)
            );
